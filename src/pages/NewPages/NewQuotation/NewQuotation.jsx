...
const NewQuotation = () => {
  ...
  return (
    <div className="newQuotation">
      ...
      <div className="newQuotation-top">
        <Link onClick={() => navigate(-1)} className="newQuotation-top-left">
          <ChevronLeft size={30} />
          <h3>Create Quotation</h3>
        </Link>

        <div className="newQuotation-top-right">
      ...
      <div className="newQuotation-customer">
        <div className="newQuotation-customer-left">
          <div className="newQuotation-customer-left-top">
        ...
        <div className="newQuotation-customer-right">
          <div className="newQuotation-customer-right-top">
            <span>Other Details</span>
          </div>

          <div className="newQuotation-customer-right-items">
            <div className="newQuotation-customer-right-item">
      ...
      <div className="newQuotation-product">
        <div className="newQuotation-product-top">
        ...
        <div className="newQuotation-product-content">
          <div className="newQuotation-product-content-top">
            <div className="newQuotation-product-content-top-item search-input">
              <Search className="search-icon" />
              <input
                type="search"
            ...
            <div className="newQuotation-product-content-top-item">
          ...
          <div className="newQuotation-products-table">
            {/* {tableData.map((item, index) => (
              <div className="newQuotation-products-table-items">
                <div className="newQuotation-products-table-item">
                  <p>Product Name</p>
            ...
            <div className="newQuotation-products-table-add">
